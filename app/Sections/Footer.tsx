        ...
        <footer className="lg:h-[45vh] flex flex-col justify-between bg-neutral-800 px-4 py-8 lg:p-10">
            <div className="flex flex-col lg:flex-row justify-between gap-4">
                <div className="text-neutral-200 lg:max-w-[30%]">
                    ...
                    <p className="text-neutral-400 mt-4 text-sm max-w-[70%] lg:w-fit lg:text-lg">Every detail considered, every flavour perfected. Fast never meant ordinary — and it never will.</p>
                    ...
                    <ul className="flex gap-2 py-4">
                        ...
                        socials.map((link, i) => {
                            ...
                            <Link key={i} href={link.href} target="blank">
                                <Icon strokeWidth={1} size={30} className="text-neutral-400 hover:text-neutral-200 transition-all" />
                            </Link>
                            )
                        })
                        }
                ...
                <div className="flex flex-col lg:flex-row gap-1 lg:gap-8">
                    {
                    links.map((link,i) => (
                        <Link key={i} href={link.href} className="text-neutral-400 hover:text-neutral-200 transition-all">
                            {link.label}
                        </Link>
                    ))
                    }
