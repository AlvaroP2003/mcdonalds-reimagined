...
export default function Footer() {
    ...
    return (
        <footer className="h-[50vh] flex flex-col justify-between bg-neutral-800 p-10">
            <div className="flex justify-between">
                <div className="text-neutral-200 max-w-[30%]">
                ...
                <div className="flex gap-8 text-neutral-50">
                    {
                    links.map((link,i) => (
